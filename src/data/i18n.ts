    ...
    exp: {
      ...
      items: [
        ...
        },
        {
          ...
          company: "Countigo SRL",
          date: "2020 — 2022",
          now: false,
          icon: "/company/countigo.png",
          iconBg: "#ffffff",
          points: [
            "Frontend Developer en una pyme cubana de software — foco en React para web y dos incursiones puntuales en mobile (React Native y Flutter) para cubrir requerimientos cross-platform.",
            "Web con React como foco principal: SPAs y portales corporativos, integraciones con APIs REST, gestión de estado y componentes reutilizables.",
            "Un proyecto de React Native — app móvil cross-platform (iOS/Android) con navegación, estado compartido y consumo de APIs.",
            "Un proyecto de Flutter — app móvil con Dart, widgets custom y arquitectura limpia.",
          ],
          chips: ["React", "TypeScript", "React Native", "Flutter", "REST APIs"],
        },
      ] as ExpItem[],
    },
    tech: {
    ...
    exp: {
      ...
      items: [
        ...
        },
        {
          ...
          iconBg: "#ffffff",
          points: [
            "Frontend Developer at a Cuban software firm — React-focused web work plus two targeted mobile projects (React Native and Flutter) for cross-platform client needs.",
            "Web with React as the main focus: SPAs and corporate portals, REST API integrations, state management and reusable components.",
            "One React Native project — cross-platform mobile app (iOS/Android) with navigation, shared state and API consumption.",
            "One Flutter project — Dart-based mobile app with custom widgets and clean architecture.",
          ],
          chips: ["React", "TypeScript", "React Native", "Flutter", "REST APIs"],
        },
      ] as ExpItem[],
