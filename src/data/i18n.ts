  ...
  es: {
    ...
    works: {
      ...
      others: [
        ...
        },
        {
          ...
          desc: "Servidor MCP que conecta agentes IA con Odoo. Gestión de registros, documentos y base de conocimiento.",
          tags: ["MCP", "Python", "Odoo"],
          cover: "cv-2",
          liveUrl: null,
          sourceUrl: "https://github.com/sergioperez8042/mcp_odoo",
        },
        {
          name: "Colibrí Spa",
        ...
        {
          name: "GDC 2026",
          desc: "Web corporativa con Next.js 16 y Tailwind v4. Server Components y optimización de Core Web Vitals.",
        ...
        {
          name: "Dashboard Odoo",
          desc: "Dashboard operativo TypeScript conectado a Odoo. Vistas con datos en tiempo real y exportaciones.",
          tags: ["TypeScript", "Odoo", "Charts"],
          cover: "cv-5",
          liveUrl: null,
          sourceUrl: "https://github.com/sergioperez8042/odoo_dashboard",
        },
        {
          name: "Three.js Showcase",
          desc: "Microsite con configurador 3D para una marca. Modelo GLTF, cámara orbital, variantes en tiempo real.",
          tags: ["Three.js", "WebGL"],
          cover: "cv-6",
          liveUrl: null,
          sourceUrl: null,
    ...
    footer: {
      ...
      cols: [
        {
          title: "Navegación",
          links: ["Sobre mí", "Experiencia", "Proyectos", "Notas", "Contacto"],
        },
        {
          title: "Recursos",
        ...
        {
          title: "Casos",
          links: ["Sophia Cosmetic", "Odoo MCP Bridge", "Colibrí Spa", "GDC 2026"],
        },
      ],
      copyright:
  ...
  en: {
    ...
    works: {
      ...
      others: [
        ...
        {
          name: "Odoo MCP Bridge",
          desc: "MCP server exposing Odoo models to AI agents. Safe read/write with schema validation and audit log.",
          tags: ["MCP", "Python", "Odoo"],
          cover: "cv-2",
          liveUrl: null,
          sourceUrl: "https://github.com/sergioperez8042/mcp_odoo",
        ...
        {
          name: "GDC 2026",
          desc: "Corporate site with Next.js 16 and Tailwind v4. Server Components and Core Web Vitals optimisation.",
          tags: ["Next.js", "Tailwind", "Vercel"],
          cover: "cv-4",
          liveUrl: "https://gdc2026-two.vercel.app",
          sourceUrl: "https://github.com/sergioperez8042/gdc2026",
        ...
        {
          name: "Odoo Dashboard",
          desc: "Operational TypeScript dashboard wired to Odoo. Live data views and exports for ops teams.",
          tags: ["TypeScript", "Odoo", "Charts"],
          cover: "cv-5",
          liveUrl: null,
          sourceUrl: "https://github.com/sergioperez8042/odoo_dashboard",
        ...
        {
          name: "Three.js Showcase",
          desc: "Microsite with a 3D configurator for a brand. GLTF model, orbit camera, real-time variants.",
          tags: ["Three.js", "WebGL"],
          cover: "cv-6",
          liveUrl: null,
          sourceUrl: null,
    ...
    footer: {
      ...
      cols: [
        {
          title: "Navigation",
          links: ["About", "Experience", "Work", "Notes", "Contact"],
        },
        { title: "Resources", links: ["GitHub", "LinkedIn", "Email"] },
        {
          title: "Cases",
          links: ["Sophia Cosmetic", "Odoo MCP Bridge", "Colibrí Spa", "GDC 2026"],
        },
